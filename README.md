...
Calling another API and access a second GET based on the the current now-playing API for the Youtube videos was slightly challenging. Also tried to implement a scrollbar for movie overview, but did not have enough time to finish working through the layering of layout with Scrollview and Textview before deadline. 
